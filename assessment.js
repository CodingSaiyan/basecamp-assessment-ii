...
var myFriends = ["Richard", "Brady", "Robert", "Chris"];

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("Travis");
...
function realFriends(arr) {
    arr.filter(function(people){
        if(people.friend !== false){
            trueFriends.push(people);
        }
    });
    return trueFriends;
}
